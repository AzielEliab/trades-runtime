...
- **License:** Apache-2.0
- **Product version:** 0.4.5 (Worker source). The Worker already deployed stays at 0.4.4 until this source is deployed. Public Glama listing Version is 0.3.4 and Latest is pre-0.4.4. Those are not this package version.
...
npm run pack          # builds release/trades-runtime-0.4.5.tgz via npm pack

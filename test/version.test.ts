...
describe("TR-AUDIT-2026-09-18B Option C scaffold + identity version lockstep", () => {
  it("keeps package, manifest, and catalog on 0.4.4", () => {
    ...
    expect(readFileSync("README.md", "utf8")).toMatch(/\*\*Version:\*\* 0\.4\.4/);
    ...
    expect(readFileSync("workers/giveaway/src/identity.ts", "utf8")).toMatch(/export const VERSION = "0\.4\.4"/);
    ...
    expect(glamaDocs).toMatch(/version` \(`0\.4\.4`\)/);

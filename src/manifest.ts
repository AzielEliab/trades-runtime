export const RUNTIME_MANIFEST = {
  ...
  modules: [
    ...
    { slug: "fraggate-inbound", path: "src/spine/fraggate-inbound.ts", status: "live-pure", summary: "FragGate inbound wall. First-class servicetitan / probooks / trades-app / operator-file / human. Wrapper is not verification. Scrape refused. Silent VERIFIED promotion refused." },
